  ...
  const licenses = [
    {
      ...
      details:
        "Our standard license for using fonts on a desktop computer. Perfect for freelancers, students, and creating a vast array of static design work.",
      features: [
    ...
    },
    {
      ...
      details:
        "Required if you are embedding the font file into the code of a mobile or desktop application.",
      features: [
    ...
    },
    {
      ...
      details:
        "For embedding the font into an electronic publication like an e-book, e-magazine, or interactive PDF.",
      features: [
    ...
    },
    {
      ...
      details:
        "A specific license for using the font in motion pictures, television shows, video streaming services, and broadcast commercials.",
      features: [
    ...
    <div className="bg-[#f9f9f9]">
      <div className="container mx-auto max-w-[1748px] px-6">
        <section className="py-16 sm:py-24 text-center">
          <h1 className="text-[48px] font-medium text-[#3F3F3F]">
            Our Licenses
          </h1>
          <div
            className="w-[103px] h-1 bg-[#C8705C] mx-auto my-6"
            style={{ height: "4px" }}
          ></div>
          <p className="mt-4 text-[18px] font-light text-[#3F3F3F]">
            Simple, clear, and comprehensive terms to help you create with
            confidence.
          </p>
        </section>
        ...
        <section className="pb-16 sm:pb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center gap-8">
            {licenses.map((license) => (
              // Poin 1: Kartu tanpa fill, hanya stroke
              // Poin 4: Konten rata atas, sisa ruang kosong di bawah
              <div
                key={license.title}
                className="w-[554px] h-[509px] border border-[#3F3F3F] rounded-2xl p-8 flex flex-col"
              >
                <h2 className="text-[28px] font-medium text-[#3F3F3F]">
                  {license.title}
                </h2>
                ...
                {/* Poin 2: Semua teks #3F3F3F */}
                <p className="text-[16px] font-light text-[#3F3F3F] my-6 flex-grow">
                  {license.details}
                </p>
                <ul className="space-y-4">
                  {license.features.map((feature, index) => (
                    <li key={index} className="flex items-start gap-x-3">
                      ...
                      <span className="font-light text-[#3F3F3F] text-[16px]">
                        {feature}
                      </span>
                    </li>
                  ))}
            ...
            {/* Poin 4: Card Custom Solution rata tengah */}
            <div className="w-[554px] h-[509px] border border-[#3F3F3F] rounded-2xl p-8 flex flex-col justify-center items-center text-center">
              ...
              <p className="text-[16px] font-light text-[#3F3F3F] my-6 max-w-md">
                Our team can create a tailored package that fits your project&apos;s
                unique scope and budget. We&apos;re here to help.
              </p>
              <Button
